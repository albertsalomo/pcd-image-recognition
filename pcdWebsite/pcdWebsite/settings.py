"""
Django settings for pcdWebsite project.
...
SECRET_KEY = 'django-insecure-jsb@ihsy44=7@(s(9o#r65*#(9q^+2xk*c2&ci9com&wrb&#xv'
...
WSGI_APPLICATION = 'pcdWebsite.wsgi.application'
